...
public record TidalSearchResponse(
    [property: JsonPropertyName("artists")] TidalCollection<TidalArtist>? Artists,
    [property: JsonPropertyName("albums")] TidalCollection<TidalAlbum>? Albums,
    [property: JsonPropertyName("tracks")] TidalCollection<TidalTrack>? Tracks
);

public record TidalCollection<T>(
    [property: JsonPropertyName("items")] List<T> Items,
    [property: JsonPropertyName("totalNumberOfItems")] int Total
);