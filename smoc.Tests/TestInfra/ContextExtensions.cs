...
public static class ContextExtensions {
  ...
  public static AppTestHelper AddAndLayout(this AppTestHelper context, View view) {
  ...
  /// <returns>The test context.</returns>
  public static AppTestHelper AdvanceTime(this AppTestHelper context, TimeSpan timeSpan) {
  ...
  /// <param name="context">The test context.</param>
  /// <returns>The test context.</returns>
  public static AppTestHelper ConfigureDefaultTheme(this AppTestHelper context) {
