...
public class ScreenshotDiffer {
  ...
  public void AssertEqualsGolden(AppTestHelper testContext, int goldenNum = 0, bool ansiShot = false, [CallerFilePath] string? callerPath = null, [CallerMemberName] string? callerMember = null) {
